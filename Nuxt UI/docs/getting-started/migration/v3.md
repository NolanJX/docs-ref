...
1. Wrap your app with the [App](https://ui.nuxt.com/docs/components/app) component:
...
- The `Table` component now uses [TanStack Table](https://tanstack.com/table/v8) under the hood. The `rows` prop has been renamed to `data`:
