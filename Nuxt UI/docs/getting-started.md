...
canonical_url: "https://ui.nuxt.com/docs/getting-started"
---
# Introduction
...
- [**Icons**](https://ui.nuxt.com/docs/getting-started/integrations/icons/nuxt): Access 200,000+ icons from Iconify
- [**Fonts**](https://ui.nuxt.com/docs/getting-started/integrations/fonts): Plug-and-play web font optimization and configuration
- [**Color Mode**](https://ui.nuxt.com/docs/getting-started/integrations/color-mode/nuxt): Dark and Light mode with auto detection
- [**i18n**](https://ui.nuxt.com/docs/getting-started/integrations/i18n/nuxt): Internationalize your components with 50+ languages
- [**Content**](https://ui.nuxt.com/docs/getting-started/integrations/content): Beautiful typography out of the box

**Vue:**

- [**Icons**](https://ui.nuxt.com/docs/getting-started/integrations/icons/vue): Access 200,000+ icons from Iconify
- [**Color Mode**](https://ui.nuxt.com/docs/getting-started/integrations/color-mode/vue): Dark and Light mode with auto detection
- [**i18n**](https://ui.nuxt.com/docs/getting-started/integrations/i18n/vue): Internationalize your components with 50+ languages
