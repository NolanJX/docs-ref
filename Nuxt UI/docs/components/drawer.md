...
> A drawer that smoothly slides in and out of the screen.
...
- [Drawer](https://github.com/unovue/vaul-vue)
- [GitHub](https://github.com/nuxt/ui/blob/v4/src/runtime/components/Drawer.vue)
