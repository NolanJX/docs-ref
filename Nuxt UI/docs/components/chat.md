...
> <br />
> 
> To use Nuxt UI's [prose components](https://ui.nuxt.com/docs/typography) with Comark, enable the `prose` option in your `vite.config.ts`:
> 
> ```ts [vite.config.ts]
