...
canonical_url: "https://ui.nuxt.com/docs/components/splitter"
---
# Splitter

> A set of resizable panels separated by draggable handles.
...
See commit history for [component](https://github.com/nuxt/ui/commits/v4/src/runtime/components/Splitter.vue) and [theme](https://github.com/nuxt/ui/commits/v4/src/theme/splitter.ts).

---

- [Splitter](https://reka-ui.com/docs/components/splitter)
- [GitHub](https://github.com/nuxt/ui/blob/v4/src/runtime/components/Splitter.vue)
